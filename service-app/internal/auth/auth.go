...
func (a *Auth) Authenticate(w http.ResponseWriter, r *http.Request) (User, string, error) {
	var creds userLogin
	if err := json.NewDecoder(r.Body).Decode(&creds); err != nil {
		return User{}, "", fmt.Errorf("invalid JSON payload: %w", err)
	}
...
func (a *Auth) UseCheckAuth(next http.Handler) http.HandlerFunc {
...
func (a *Auth) validateCredentials(ctx context.Context, user User) error {
