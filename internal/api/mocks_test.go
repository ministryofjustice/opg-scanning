...
func (_mock *mockWorker) Process(ctx context.Context, parsedBaseXml *types.BaseSet) (*sirius.ScannedCaseResponse, error) {
	ret := _mock.Called(ctx, parsedBaseXml)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *types.BaseSet) (*sirius.ScannedCaseResponse, error)); ok {
		return returnFunc(ctx, parsedBaseXml)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *types.BaseSet) *sirius.ScannedCaseResponse); ok {
		r0 = returnFunc(ctx, parsedBaseXml)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*sirius.ScannedCaseResponse)
		}
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *types.BaseSet) error); ok {
		r1 = returnFunc(ctx, parsedBaseXml)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_e *mockWorker_Expecter) Process(ctx interface{}, parsedBaseXml interface{}) *mockWorker_Process_Call {
	return &mockWorker_Process_Call{Call: _e.mock.On("Process", ctx, parsedBaseXml)}
}

func (_c *mockWorker_Process_Call) Run(run func(ctx context.Context, parsedBaseXml *types.BaseSet)) *mockWorker_Process_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockWorker_Process_Call) RunAndReturn(run func(ctx context.Context, parsedBaseXml *types.BaseSet) (*sirius.ScannedCaseResponse, error)) *mockWorker_Process_Call {
	_c.Call.Return(run)
	return _c
}
