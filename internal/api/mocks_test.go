...
// AddToQueueSequentially provides a mock function for the type mockJobQueue
func (_mock *mockJobQueue) AddToQueueSequentially(ctx context.Context, cfg *config.Config, data *types.BaseDocument, parsedBaseXml *types.BaseSet, scannedCaseResponse *sirius.ScannedCaseResponse) error {
	ret := _mock.Called(ctx, cfg, data, parsedBaseXml, scannedCaseResponse)

	if len(ret) == 0 {
		panic("no return value specified for AddToQueueSequentially")
	}

	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *config.Config, *types.BaseDocument, *types.BaseSet, *sirius.ScannedCaseResponse) error); ok {
		r0 = returnFunc(ctx, cfg, data, parsedBaseXml, scannedCaseResponse)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// mockJobQueue_AddToQueueSequentially_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddToQueueSequentially'
type mockJobQueue_AddToQueueSequentially_Call struct {
	*mock.Call
}

// AddToQueueSequentially is a helper method to define mock.On call
//   - ctx context.Context
//   - cfg *config.Config
//   - data *types.BaseDocument
//   - parsedBaseXml *types.BaseSet
//   - scannedCaseResponse *sirius.ScannedCaseResponse
func (_e *mockJobQueue_Expecter) AddToQueueSequentially(ctx interface{}, cfg interface{}, data interface{}, parsedBaseXml interface{}, scannedCaseResponse interface{}) *mockJobQueue_AddToQueueSequentially_Call {
	return &mockJobQueue_AddToQueueSequentially_Call{Call: _e.mock.On("AddToQueueSequentially", ctx, cfg, data, parsedBaseXml, scannedCaseResponse)}
}

func (_c *mockJobQueue_AddToQueueSequentially_Call) Run(run func(ctx context.Context, cfg *config.Config, data *types.BaseDocument, parsedBaseXml *types.BaseSet, scannedCaseResponse *sirius.ScannedCaseResponse)) *mockJobQueue_AddToQueueSequentially_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg3 *types.BaseSet
		if args[3] != nil {
			arg3 = args[3].(*types.BaseSet)
		}
		var arg4 *sirius.ScannedCaseResponse
		if args[4] != nil {
			arg4 = args[4].(*sirius.ScannedCaseResponse)
		}
		run(
			arg0,
			arg1,
...
func (_c *mockJobQueue_AddToQueueSequentially_Call) Return(err error) *mockJobQueue_AddToQueueSequentially_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockJobQueue_AddToQueueSequentially_Call) RunAndReturn(run func(ctx context.Context, cfg *config.Config, data *types.BaseDocument, parsedBaseXml *types.BaseSet, scannedCaseResponse *sirius.ScannedCaseResponse) error) *mockJobQueue_AddToQueueSequentially_Call {
	_c.Call.Return(run)
	return _c
}
