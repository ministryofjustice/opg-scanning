...
// Process provides a mock function for the type mockJobQueue
func (_mock *mockJobQueue) Process(ctx context.Context, scannedCaseResponse *sirius.ScannedCaseResponse, parsedBaseXml *types.BaseSet) error {
	ret := _mock.Called(ctx, scannedCaseResponse, parsedBaseXml)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *sirius.ScannedCaseResponse, *types.BaseSet) error); ok {
		r0 = returnFunc(ctx, scannedCaseResponse, parsedBaseXml)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// mockJobQueue_Process_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Process'
type mockJobQueue_Process_Call struct {
	*mock.Call
}
...
func (_e *mockJobQueue_Expecter) Process(ctx interface{}, scannedCaseResponse interface{}, parsedBaseXml interface{}) *mockJobQueue_Process_Call {
	return &mockJobQueue_Process_Call{Call: _e.mock.On("Process", ctx, scannedCaseResponse, parsedBaseXml)}
}

func (_c *mockJobQueue_Process_Call) Run(run func(ctx context.Context, scannedCaseResponse *sirius.ScannedCaseResponse, parsedBaseXml *types.BaseSet)) *mockJobQueue_Process_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 *types.BaseSet
		if args[2] != nil {
			arg2 = args[2].(*types.BaseSet)
		}
		run(
			arg0,
			arg1,
...
func (_c *mockJobQueue_Process_Call) Return(err error) *mockJobQueue_Process_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockJobQueue_Process_Call) RunAndReturn(run func(ctx context.Context, scannedCaseResponse *sirius.ScannedCaseResponse, parsedBaseXml *types.BaseSet) error) *mockJobQueue_Process_Call {
	_c.Call.Return(run)
	return _c
}
